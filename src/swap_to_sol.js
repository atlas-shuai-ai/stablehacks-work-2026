...
async function swap() {
    ...
    // 卖出 0.5 USDC -> SOL
    // USDC 精度为 6 位，0.5 USDC = 500,000
    const amount = 500000; 
    const quoteUrl = `https://public.jupiterapi.com/quote?inputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&outputMint=So11111111111111111111111111111111111111112&amount=${amount}&slippageBps=50`;
    
    console.log('Fetching quote (Sell USDC)...');
    ...
    console.log('Quote received. Expected SOL:', quoteResponse.outAmount / 1e9);
